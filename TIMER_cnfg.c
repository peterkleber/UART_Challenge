...
{		
		...
		{TIMER0,NORMAL_MODE,NORMAL,INTERRUPT,NA,PRESCALER1024 ,NOT_INITIALIZED},
		{TIMER1,CTC_MODE,NORMAL,INTERRUPT,NO_ICU_USED,PRESCALER1024,NOT_INITIALIZED},
		{TIMER2,NORMAL_MODE,NORMAL,INTERRUPT,NA,PRESCALER1024 ,NOT_INITIALIZED}
